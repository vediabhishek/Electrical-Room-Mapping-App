...
export const BuildingList = ({ navigation }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      if (editingBuilding) {
        const res = await fetch(`https://ais-dev-meuehu4hqz4z4zkwipb2y3-586792953856.asia-southeast1.run.app/api/buildings/${editingBuilding.id}`, {
          method: 'PUT',
        ...
        const res = await fetch('https://ais-dev-meuehu4hqz4z4zkwipb2y3-586792953856.asia-southeast1.run.app/api/buildings', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({ name: newName, address: newAddress })
        });
        ...
        setBuildings([{ ...data, name: newName, address: newAddress, floor_count: 0 }, ...buildings]);
      }
    ...
    Alert.alert(
      ...
      [
        ...
        { 
          ...
          onPress: async () => {
            try {
              const res = await fetch(`https://ais-dev-meuehu4hqz4z4zkwipb2y3-586792953856.asia-southeast1.run.app/api/buildings/${id}`, {
                method: 'DELETE'
              });
