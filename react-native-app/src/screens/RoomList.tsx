...
export const RoomList = ({ route, navigation }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      if (editingRoom) {
        const res = await fetch(`https://ais-dev-meuehu4hqz4z4zkwipb2y3-586792953856.asia-southeast1.run.app/api/rooms/${editingRoom.id}`, {
          method: 'PUT',
        ...
        const res = await fetch(`https://ais-dev-meuehu4hqz4z4zkwipb2y3-586792953856.asia-southeast1.run.app/api/floors/${floorId}/rooms`, {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({ name: newName, type: newType })
        });
        ...
        setRooms([...rooms, { ...data, name: newName, type: newType, board_count: 0 }]);
      }
    ...
    Alert.alert(
      ...
      [
        ...
        { 
          ...
          onPress: async () => {
            try {
              const res = await fetch(`https://ais-dev-meuehu4hqz4z4zkwipb2y3-586792953856.asia-southeast1.run.app/api/rooms/${id}`, {
                method: 'DELETE'
              });
